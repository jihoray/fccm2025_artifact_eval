#include "huffman.h"
#include "assert.h"
int huffman_encoding(
    /* input */ Symbol symbol_histogram[INPUT_SYMBOL_SIZE],
    /* output */ PackedCodewordAndLength encoding[INPUT_SYMBOL_SIZE]) {
#pragma HLS INTERFACE m_axi port = symbol_histogram depth=256 offset = slave bundle = a_port
#pragma HLS INTERFACE m_axi port = encoding depth=256 offset = slave bundle = b_port
