...
{
  #pragma HLS INTERFACE m_axi port = X_R depth=1024 offset = slave bundle = a_port
  #pragma HLS INTERFACE m_axi port = X_I depth=1024 offset = slave bundle = b_port
  #pragma HLS INTERFACE m_axi port = OUT_R depth=1024 offset = slave bundle = c_port
  #pragma HLS INTERFACE m_axi port = OUT_I depth=1024 offset = slave bundle = d_port
