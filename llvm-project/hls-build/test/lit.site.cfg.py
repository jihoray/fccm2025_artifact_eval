## Autogenerated from /usr/scratch/jkim3998/bc_test/RealProbe/llvm-project/llvm/test/lit.site.cfg.py.in
## Do not edit!
...
config.llvm_lib_dir = "/usr/scratch/jkim3998/bc_test/RealProbe/llvm-project/hls-build/./lib"
...
config.host_ldflags = "-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/usr/scratch/jkim3998/.conda/dst_jiho/hlsllvm/lib -Wl,-rpath-link,/usr/scratch/jkim3998/.conda/dst_jiho/hlsllvm/lib -L/usr/scratch/jkim3998/.conda/dst_jiho/hlsllvm/lib -Wl,-allow-shlib-undefined"
...
lit_config.load_config(config, "/usr/scratch/jkim3998/bc_test/RealProbe/llvm-project/llvm/test/lit.cfg.py")
